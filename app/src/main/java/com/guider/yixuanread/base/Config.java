...
public class Config {
    ...
    public Typeface getTypeface(){
        if (typeface == null){
            String typePath = sp.getString(FONT_TYPE_KEY,FONTTYPE_DEFAULT);
    ...
    public Typeface getTypeface(String typepath){
        Typeface mTypeface;
        if (typepath.equals(FONTTYPE_DEFAULT)){
            mTypeface = Typeface.DEFAULT;
        } else {
            mTypeface = Typeface.createFromAsset(mContext.getAssets(),typepath);
        }
        return mTypeface;
    }
    public void setTypeface(String typepath){
        typeface = getTypeface(typepath);
        sp.edit().putString(FONT_TYPE_KEY,typepath).commit();
    }
