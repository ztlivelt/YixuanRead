package com.guider.yixuanread.dialog;
...
public class PageModeDialog extends Dialog{
    ...
    public PageModeDialog(@NonNull Context context) {
        this(context, R.style.setting_dialog);
    }

    public PageModeDialog(@NonNull Context context, int themeResId) {
        super(context, themeResId);
    }

    protected PageModeDialog(@NonNull Context context, boolean cancelable, @Nullable OnCancelListener cancelListener) {
